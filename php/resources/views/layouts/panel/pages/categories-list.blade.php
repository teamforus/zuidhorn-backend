...
<h4 class="heading-title">
    ...
    <div class="btn-group pull-right">
        <a class="btn btn-default" href="{{ url('/panel/categories/edit') }}"><em class="glyphicon glyphicon-plus"> </em> Add new</a>
        ...
        <form class="form">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Name</label>
                        <input class="form-control" name="text" placeholder="Name">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
